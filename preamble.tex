...
\newcommand{\greybox}[1]{
	\begin{mdframed}[
		backgroundcolor=orange!0!white,
		linewidth=0.2pt,
		innerleftmargin=5pt,
...
\usepackage{xspace}
\newcommand{\sosy}[1]{\textsf{\color{blue!40!black}#1}\xspace}
...
\newcommand{\xzwo}{\sosy{z264}}
\newcommand{\zdrei}{\sosy{z3}}

\definecolor{cs-color-raw}{HTML}{ffa822}
\definecolor{lt-color-raw}{HTML}{134e6f}
\definecolor{xmt-color-raw}{HTML}{ff6150}
\definecolor{nmt-color-raw}{HTML}{1ac0c6}
