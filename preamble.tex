...
% configure hyperlinks and fancy colors
...
% Macro for research questions \RQ{}
\newcommand{\RQ}[2]{
	\vspace{0.5em}
...
% hack hack for author alignment -> provide linebreak with centering
