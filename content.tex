...
\vspace{2mm}
\greybox{\textbf{Summary} (\RQref{2}): Input sensitivity can manifest in different ways, including in high spread across workloads and conditional influence or sign flipping depending the workload.}
...
\subsection{Clustering Execution Footprints}
...
\subsubsection{Sign Flipping}
\subsubsection{Conditional Influences}
\subsubsection{High Spread}
