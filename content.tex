...
Foundation (DFG) under the contract \textbf{{\color{red} UPDATE}}. Siegmund's work has been supported by the DFG under the
contract(s) \textbf{{\color{red} UPDATE}} and \textbf{{\color{red} UPDATE}} and by the German
Ministry of Education and Research (BMBF) under the contract \textbf{{\color{red} UPDATE}}. 
