...
\greybox{RQ 1.2 \textit{Are there workload-specific differences in code coverage for configurations of a software system?}}

\greybox{RQ 1.3 \textit{Do workload-specific differences in code coverage correspond to differences in performance influence?}}

\subsection{Code Coverage for Representativeness}

\greybox{RQ 2.1 \textit{Can we use different workloads to identify option-specific code sections via superimposition?}}

\greybox{RQ 2.2 \textit{Can we use code coverage or option-code coverage as a indicator for representativeness?}}
