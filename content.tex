...
\begin{table}[ht!]
	...
	\begin{tabular}{p{1.2cm}p{1.2cm}rp{4.3cm}} % h2 batik jadx
		...
		\multirow{5}{*}{\parbox{1.3cm}{\centering Conditional Influences}} & \jumper & 3 & \textsf{Mono, MidSideStereo, JointStereo}\\
		\cmidrule{2-4}
