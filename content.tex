...
\vspace{1mm}
\greybox{\textbf{Summary} (\RQref{2}): Workloads and their characteristics can affect configuration options' performance influence in various ways (e.g., conditioning influence, introducing variance), yet identifying relevant workload characteristics is highly domain-specific cannot be considered trivial. 
}
