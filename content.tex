...
\subsection{Relationship between Configuration-Specific Code Coverage and Workload Variation ($\text{RQ}_\text{3}$)}\label{sec:rq3}\label{sec:categories}
