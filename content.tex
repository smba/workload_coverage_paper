...
\paragraph*{Results} {\color{blue} Heatmaps with Kendall's $\tau$ + Categories count Figure~\ref{fig:diff_performance_similarity}}  and Table~\ref{tab:categorization}\\
