...
\subsubsection{Mapping Options to Code Segments}\label{sec:feature_location}
...
\subsubsection{Spectrum-based Feature Location}
...
\begin{table}
	...
	\centering
\begin{tabular*}{\linewidth}{lp{5cm}p{3cm}}	
	\toprule
...
\begin{tabular}{lrrrrrrrr}	
	\toprule
	\textbf{Subject System} & \multicolumn{2}{c}{\cellcolor{cs-color}\textbf{\textsf{CS} Pairs}} & \multicolumn{2}{c}{\cellcolor{lt-color}\textbf{\textsf{LT} Pairs}} & \multicolumn{2}{c}{\textbf{\cellcolor{xmt-color}\textsf{XMT} Pairs}} & \multicolumn{2}{c}{\cellcolor{nmt-color}\textbf{\textsf{NMT} Pairs}}\\
