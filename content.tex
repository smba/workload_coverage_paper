...
\vspace{2mm}
\greybox{\textbf{Summary} (\RQref{1}): The subject systems' performance distributions exhibit different types of relationships, \textit{mostly linear}, but, to a substantial part, also \textit{non-monotonous transformations}.}
