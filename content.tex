...
\paragraph*{Results} {\color{blue} Differences between performance models Figure~\ref{fig:model_similarity}}\\

\begin{figure}
	\includegraphics[width=\linewidth]{images/rq2/performance_influence_variability.pdf}
	
	\caption{\color{orange}caption this}
