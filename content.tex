...
For the \textit{Java decompiler} \jadx, the measured task was to decompile a number of Android applications in DEX byte code. We selected a number of APK packages from \url{APKMirror.com/} from different domains (social media, games, utility etc.) and of varying size.
...
\begin{table}
	...
	\centering
\begin{tabular}{lp{4.0cm}p{2.6cm}}	
	\toprule
	 ...
	 \rowcolor{lt-color!40!white}\cellcolor{lt-color}\textit{\textbf{LT}} & {Strictly linear transformation} & $r^* \geq 0.6$ \\
	\rowcolor{xmt-color!40!white}\cellcolor{xmt-color}\textit{\textbf{XMT}} & {Strictly monotonous transformation} & $r^* < 0.6 $ and $ \tau^* \geq 0.6$ \\
...
\begin{tabular}{p{1.5cm}rrrrrr}	
	\toprule
	\textbf{System} & \multicolumn{2}{c}{\textbf{\cellcolor{lt-color}\textit{LT}}} & \multicolumn{2}{c}{\textbf{\cellcolor{xmt-color}\textit{XMT}}} & \multicolumn{2}{c}{\textbf{\cellcolor{nmt-color}\textit{NMT}}}\\
	...
	\xzwo & 
	%0 & 0\,\% & 
	\cellcolor{lt-color!100!white}360 & \cellcolor{lt-color!100!white}100\,\% & 
	0 & 0\,\% & 
	0 & 0\,\%\\
...
The goal of this selection is to study the \textbf{presence} and quality of workload-option interactions, but not their \textbf{prevalence}. Hence, we are confident that this selection does not invalidate our findings.
