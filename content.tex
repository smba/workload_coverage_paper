...
\begin{compactitem}
	...
	\item An archived repository\footnote{\bfseries\color{red} LINK OR REFERENCE TO FIGSHARE!} with supplementary material including performance and coverage measurements, {\color{red}experiment workloads} and configurations, and an interactive dashboard for data exploration to \textit{reproduce} all analyses and additional visualizations left out due to space limitations.
\end{compactitem}
