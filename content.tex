...
\clearpage
\section{Discussion}
\subsection{Feature-level Input Sensitivity}

\begin{compactitem}
	\item wird nicht hergenommen in der Domain
	\item wir zeigen, dass das eigentlich aber relevant ist
	\item BEtrachtung in anderen Bereichen vorhanden, im Feature Context 
	\item Bestimmte Features sind betroffen, mache nicht (highly-specific)!
\end{compactitem}

\greybox{\textbf{Lesson 1:} Robust and practical configuration-specific performance models require input sensitivity analysis for individual configuration options.  
}
...
\begin{compactitem}
	...
	\item wir zeigen, dass das eigentlich aber relevant ist
\end{compactitem}
\greybox{\textbf{Insight:} Stuff is cool
}
